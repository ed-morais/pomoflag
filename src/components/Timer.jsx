  ...
  if (secondsLeft === 0) {
    return (
      <div className="flex flex-col items-center gap-6">
        ...
        <button
          onClick={reset}
          className="px-6 py-2 rounded-lg bg-gray-200 hover:bg-gray-300 dark:bg-gray-800 dark:hover:bg-gray-700 dark:text-white text-gray-800 font-medium transition-colors"
        >
          Reset
        </button>
      </div>
